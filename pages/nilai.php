...
<?php
    ...
    $_SESSION['aktif'] = "nilai";
    $_SESSION['hrefmenu'] = "nilai";
    $_SESSION['Text'] = "Entri Data";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Nilai Preferensi</title>
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <a href="addnilai" class="pull-right" data-toggle='modal' data-target='#remoteModal' data-backdrop='static'
                                        ...
                                        <button class="btn primary">
                                            ...
                                            </span> Tambah Nilai Preferensi
                                        </button>
                                    </a>
                                    <div class="table-responsive">
                                        <table id="datanilai" name="datanilai" class="table datatable-responsive table-bordered table-hover" 
...
-->
        ...
        <script>
            ...
            function getdelete(nilaiid){
                swal({
                    ...
                    if (result.value){
                        ...
                        swal("Dibatalkan", "Anda membatalkan penghapusan data nilai", "error");
                        return false;
                    }
                });
            }
            $(document).ready(function(){
                var datanilai;
                datanilai = $('#datanilai').DataTable({
                    "responsive": true,
                    "serverSide": true,
                    "ajax": "data/datanilai.php",
                    "columns":[
                    ...
                    language: {
                        ...
                        "zeroRecords": "Tidak ada data yang cocok dengan nilai pencarian anda",
