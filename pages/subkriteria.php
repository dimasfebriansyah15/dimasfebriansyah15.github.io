...
<?php
    ...
    $_SESSION['aktif'] = "subkriteria";
    $_SESSION['hrefmenu'] = "subkriteria";
    $_SESSION['Text'] = "Entri Data";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Sub Kriteria</title>
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <a href="addsubkriteria" class="pull-right" data-toggle='modal' data-target='#remoteModal' data-backdrop='static'
                                        ...
                                        <button class="btn primary">
                                            ...
                                            </span> Tambah Sub Kriteria
                                        </button>
                                    </a>
                                    <form>
                                    <div class="form-group row">
                                        <label class="col-md-2 control-label1" for="kriteriaid">Nama Kriteria</label>
                                        <div class="col-md-3">
...
?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="datasubkriteria" name="datasubkriteria" class="table datatable-responsive table-bordered table-hover" 
...
-->
        ...
        <script>
            ...
            function getdelete(subkriteriaid){
                swal({
                    ...
                    if (result.value){
                        window.location = 'deletesubkriteria-'+subkriteriaid;
                    }
                    else if (result.dismiss === 'cancel'){
                        swal("Dibatalkan", "Anda membatalkan penghapusan data sub kriteria", "error");
                        return false;
                    }
                });
            }
            $(document).ready(function(){
                var datasubkriteria;
                datasubkriteria = $('#datasubkriteria').DataTable({
                    "responsive": true,
                    "serverSide": true,
                    "ajax": {
                        url : "data/datasubkriteria.php",
                        "data": function (d){
                            return $.extend({}, d,{
                                "KriteriaId": $('#kriteriaid').val()
                            });
                        }
                    },
                    "columns":[
                        ...
                        {"sortable": false, "class": "text-center", "data": "3"}
                    ],
                    ...
                    "columnDefs":[
                        {
                            ...
                            "render": function ( data, type, full, meta ){
                                return "<a href='editsubkriteria-"+data+"' "+
