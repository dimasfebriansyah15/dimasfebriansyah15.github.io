...
<div class="modal-content box">
    <div class="modal-header">
        ...
        <h6 class="text-muted">Tambah Sub Kriteria</h6>
    </div>
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-12">
                <form class="form-horizontal" id="subkriteriaform" name="subkriteriaform" method="post" action="simpansubkriteria">
                    <div class="box">
                        <div class="box-body">
...
<script>
    function SubkriteriaId(){
        var SubkriteriaId = document.getElementById('subkriteriaid');
        var NamaSubriteria = document.getElementById('namasubkriteria');
        $.ajax({
            dataType: 'json',
            url: "data/maxid.php",
            type: "GET",
            ...
            success: function(data){
                $.each(data, function(i, n){
                    var kode1 = n["id"];
                    SubkriteriaId.value = kode1;
                    NamaSubriteria.value = "";
                });
            }
        });
    }
