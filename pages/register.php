...
<?php
    ...
    $_SESSION['aktif'] = "register";
    $_SESSION['hrefmenu'] = "register";
    $_SESSION['Text'] = "";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Registrasi User</title>
...
?>
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <a href="addregister" class="pull-right" data-toggle='modal' data-target='#remoteModal' data-backdrop='static'
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataregistrasi" name="dataregistrasi" class="table datatable-responsive table-bordered table-hover"
        ...
        <div class="modal fade animate" id="remoteModal1" role="dialog">
            <div class="modal-dialog modal-lg" id="animate"></div>
        </div>
        ...
        <script>
            ...
            function getdelete(groupid){
                swal({
                    ...
                    if (result.value){
                        window.location = 'deleteregister-'+groupid;
                    }
                    else if (result.dismiss === 'cancel'){
                        swal("Dibatalkan", "Anda membatalkan penghapusan data group", "error");
                        return false;
                    }
                });
            }
            $(document).ready(function(){
                var dataregistrasi;
                dataregistrasi = $('#dataregistrasi').DataTable({
                    "responsive": true,
                    "serverSide": true,
                    "ajax": "data/datauser.php",
                    "columns":[
                        ...
                        {"sortable": false, "data": "5"},
                        {"sortable": false, "class": "text-center", "data": "6"}
                    ],
                    ...
                    "columnDefs":[
                        {
                            ...
                            "render": function ( data, type, full, meta ){
                                return "<a href='editregister-"+data+"' "+
