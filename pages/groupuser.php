...
<?php
    ...
    $_SESSION['aktif'] = "group";
    $_SESSION['hrefmenu'] = "group";
    $_SESSION['Text'] = "";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Group User</title>
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <a href="addgroup" class="pull-right" data-toggle='modal' data-target='#remoteModal' data-backdrop='static'
                                    ...
                                    <div class="table-responsive">
                                        <table id="datagroupuser" name="datagroupuser" class="table table-bordered table-hover" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th width="70">No</th>
                                                    <th>Nama Group</th>
        ...
        <script>
            ...
            function getdelete(groupid){
                swal({
                    ...
                    text: "Ingin menghapus data group ini ?",
                    type: "warning",
                    ...
                    if (result.value){
                        window.location = 'deletegroup-'+groupid;
                    }
            ...
            $(document).ready(function(){
                var datagroup;
                datagroup = $('#datagroupuser').DataTable({
                    "responsive": true,
                    "serverSide": true,
                    "ajax": "data/datagroup.php",
                    "columns":[
