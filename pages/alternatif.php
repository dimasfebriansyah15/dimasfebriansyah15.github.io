...
<?php
    ...
    $_SESSION['aktif'] = "alternatif";
    $_SESSION['hrefmenu'] = "alternatif";
    $_SESSION['Text'] = "Entri Data";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Alternatif</title>
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <a href="addalternatif" class="pull-right" data-toggle='modal' data-target='#remoteModal' data-backdrop='static'
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataalternatif" name="dataalternatif" class="table datatable-responsive table-bordered table-hover" 
...
-->
        ...
        <script>
            ...
            function getdelete(alternatifid){
                swal({
                    title: "Apakah anda yakin",
                    text: "Ingin menghapus data alternatif ini ?",
                    type: "warning",
                    ...
                    if (result.value){
                        window.location = 'deletealternatif-'+alternatifid;
                    }
                    else if (result.dismiss === 'cancel'){
                        swal("Dibatalkan", "Anda membatalkan penghapusan data alternatif", "error");
                        return false;
                    }
                });
            }
            $(document).ready(function(){
                ...
                dataalternatif = $('#dataalternatif').DataTable({
                    "responsive": true,
                    "serverSide": true,
                    "ajax": "data/dataalternatif.php",
                    "columns":[
                        {"sortable": true, "class": "text-center", "data": "0"},
                        {"sortable": false, "data": "1"},
                        {"sortable": false, "class": "text-center", "data": "2"}
                    ],
                    ...
                    language: {
                        ...
                        "zeroRecords": "Tidak ada data yang cocok dengan alternatif pencarian anda",
                    ...
                    "columnDefs":[
                        {
                            ...
                            "render": function ( data, type, full, meta ){
                                return "<a href='editalternatif-"+data+"' "+
