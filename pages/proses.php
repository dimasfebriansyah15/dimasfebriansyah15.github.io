<?php
    ...
    $_SESSION['aktif'] = "proses";
    $_SESSION['hrefmenu'] = "proses";
    $_SESSION['Text'] = "";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Proses Hitung</title>
...
?>
                ...
                <div ui-view class="app-body" id="view">
                    ...
                    <div class="padding">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="prosesform" name="prosesform" action="proseshitung" role="form" class="">
                                    <div class="box">
                                        <div class="box-header">
                                          <h2>Proses Hitung SAW</h2>
                                          <small>Proses ini untuk menentukan berapa bonus yang akan di terima karyawan berdasarkan penilaian karyawan.</small>
                                        </div>
                                        <div class="box-divider m-a-0"></div>
                                        <div class="box-body">
                                            <div class="form-group">
                                                <div class="progress progress-striped active">
                                                    <div class="progress-bar primary" style="width: 0%"><span id="text">0%</span></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="box-divider m-a-0"></div>
                                        <div class="box-footer">
                                            <div class="form-actions text-center">
                                                <button id="proses" name="proses" type="submit" class="btn primary">
                                                    <span class="nav-icon">
                                                        <i class="material-icons">&#xe88b;
                                                            <span ui-include="'assets/images/i_0.svg'"></span>
                                                        </i>
        ...
        <script src="libs/jquery/jquery/dist/bootstrap-waitingfor.js"></script>
        <!-- Bootstrap -->
                ...
                $("#prosesform").on('submit', function(e){
                    ...
                    $(this).ajaxSubmit({
                        beforeSend: function(){
                            ...
                            text.html(percentVal);
                            waitingDialog.show('Harap Tunggu, Sedang Proses Hitung ...');
                        },
                        success: function(data){
                            ...
                            if(data === 'true'){
                                ...
                                swal({
                                    title: "Aplikasi SAW",
                                    text: "Proses Hitung Ada Yang Gagal",
                                    type: "error",
                                    confirmButtonClass: "btn primary",
                                    buttonsStyling: false,
                                    reverseButtons: true
