...
<?php
    ...
    $_SESSION['aktif'] = "parameter";
    $_SESSION['hrefmenu'] = "parameter";
    $_SESSION['Text'] = "Entri Data";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Parameter Sistem</title>
                    ...
                    <div class="p-a white lt box-shadow">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Entri Data</li>
                                    <li class="breadcrumb-item active">Parameter Sistem</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header">
                                    <h2>Data Parameter Sistem</h2>
                                    <a href="addparameter" class="pull-right" data-toggle='modal' data-target='#remoteModal' data-backdrop='static'
                                        ...
                                        <button class="btn primary">
                                            ...
                                            </span> Tambah Parameter
                                        </button>
                                    </a>
                                    <div class="table-responsive">
                                        <table id="dataparameter" name="dataparameter" class="table datatable-responsive table-bordered table-hover" 
                                            width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th width="70">No</th>
                                                    <th>Tingkat</th>
                                                    <th>Bonus Karyawan</th>
                                                    <th>Kondisi</th>
                                                    <th>Keterangan</th>
...
-->
        ...
        <script>
            ...
            function getdelete(parameterid){
                swal({
                    title: "Apakah anda yakin",
                    text: "Ingin menghapus data parameter ini ?",
                    type: "warning",
                    ...
                    if (result.value){
                        window.location = 'deleteparameter-'+parameterid;
                    }
                    else if (result.dismiss === 'cancel'){
                        swal("Dibatalkan", "Anda membatalkan penghapusan data parameter", "error");
                        return false;
                    }
                });
            }
            $(document).ready(function(){
                var dataparameter;
                dataparameter = $('#dataparameter').DataTable({
                    "responsive": true,
                    "serverSide": true,
                    "ajax": "data/dataparameter.php",
                    "columns":[
                        {"sortable": true, "class": "text-center", "data": "0"},
                        {"sortable": false, "data": "1"},
                        {"sortable": false, "data": "2"},
                        {"sortable": false, "data": "3"},
                        {"sortable": false, "data": "4"},
                        {"sortable": false, "class": "text-center", "data": "5"}
                    ],
                    ...
                    language: {
                        ...
                        "zeroRecords": "Tidak ada data yang cocok dengan parameter pencarian anda",
                    ...
                    "columnDefs":[
                        {
                            ...
                            "render": function (data, type, row){
                                return '<td class="text-center">Rp. '+addCommas(data)+'</td>';
                            }
                        },
                        {
                            "targets": 5,
                            ...
                            "render": function ( data, type, full, meta ){
                                return "<a href='editparameter-"+data+"' "+
