...
<?php
    ...
    $_SESSION['aktif'] = "kriteria";
    $_SESSION['hrefmenu'] = "kriteria";
    $_SESSION['Text'] = "Entri Data";
?>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Aplikasi SAW - Kriteria</title>
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header">
                                    <h2>Data Kriteria</h2>
                                    <a href="addkriteria" class="pull-right" data-toggle='modal' data-target='#remoteModal' data-backdrop='static'
                                        ...
                                        <button class="btn primary">
                                            ...
                                            </span> Tambah Kriteria
                                        </button>
                                    </a>
                                    <div class="table-responsive">
                                        <table id="datakriteria" name="datakriteria" class="table datatable-responsive table-bordered table-hover" 
...
-->
        ...
        <script>
            ...
            function getdelete(kriteriaid){
                swal({
                    title: "Apakah anda yakin",
                    text: "Ingin menghapus data kriteria ini ?",
                    type: "warning",
                    ...
                    if (result.value){
                        window.location = 'deletekriteria-'+kriteriaid;
                    }
                    else if (result.dismiss === 'cancel'){
                        swal("Dibatalkan", "Anda membatalkan penghapusan data kriteria", "error");
                        return false;
                    }
                });
            }
            $(document).ready(function(){
                var datakriteria;
                datakriteria = $('#datakriteria').DataTable({
                    "responsive": true,
                    "serverSide": true,
                    "ajax": "data/datakriteria.php",
                    "columns":[
                    ...
                    "columnDefs":[
                        {
                            ...
                            "render": function ( data, type, full, meta ){
                                return "<a href='editkriteria-"+data+"' "+
